...
class Individual_algo_genetic:
    ...
    def Cluster_group_change(self, p1,p2,new_parcel1,new_parcel2,cluster_state,cut_gene=0):
        ...
        if cluster_state == True:
            ...
            #print(self.m_GroupCluserList,"mgroup cluster")
            self.m_GroupCluserList.append(new_parcel1)
            self.m_GroupCluserList.append(new_parcel2)
            #print(self.m_GroupCluserList,"mgroup cluster after")
            # print(new_parcel1,"1")
            # print(new_parcel2,"2")
    ...
    def changeParcel_cluster(self,p1,p2,new_parcel1=[],new_parcel2=[]):
        ...
        while self.m_totalCost+first_parcel.returnCost() <= 50 and first_parcel.returnType()!="R" and first_parcel not in self.m_CluserList:
            ...
            self.m_GroupCluserList.insert(index,first_parcel)
    ...
    def draw_matrix(self):
        ...
        y =len(matrix)
        x = len(matrix[0])
        print("draw list",len(self.m_CluserList))
        ...
        for i in range(y):
            for j in range(x):
                ...
                parcel=matrix[i][j]
                if parcel in self.m_CluserList:
                    data[i, j] = "4"
                if char != 'x':
